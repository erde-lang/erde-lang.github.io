...
var monaco_contribution = __webpack_require__(15422);
...
var LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (fileName) {
        var uri = monaco_editor_core/* Uri.parse */.Sf.parse(fileName);
...
var InlayHintsAdapter = /** @class */ (function (_super) {
    ...
    InlayHintsAdapter.prototype._convertHintKind = function (kind) {
        switch (kind) {
            case 'Parameter':
                return monaco_editor_core/* languages.InlayHintKind.Parameter */.Mj.InlayHintKind.Parameter;
            case 'Type':
                return monaco_editor_core/* languages.InlayHintKind.Type */.Mj.InlayHintKind.Type;
            default:
                return monaco_editor_core/* languages.InlayHintKind.Other */.Mj.InlayHintKind.Other;
        }
    };
...
function setupMode(defaults, modeId) {
    ...
    monaco_editor_core/* languages.registerRenameProvider */.Mj.registerRenameProvider(modeId, new RenameAdapter(libFiles, worker));
    monaco_editor_core/* languages.registerInlayHintsProvider */.Mj.registerInlayHintsProvider(modeId, new InlayHintsAdapter(worker));
